...
class AddTeam extends React.Component{
    ...
    addData(){
        ...
        const data = this.props.getMemberQuery;
    ...
    submitForm(e){
        ...
        if(this.state.memberId){ // Update post

            this.props.updateMemberMutation({
    ...
    render(){
        return(
            <div className='main__show home__box all__box'>
                ...
                <Link to='/team' style={style}><div className = 'back'><div className="set">&larr;</div></div></Link>
