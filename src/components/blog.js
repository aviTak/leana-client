...
import { deleteBlogMutation } from '../queries/mutations';
...
class Blog extends React.Component {
    ...
    submitForm(e){ 
        ...
        var data = this.props.getBlogsQuery;
    ...
    displayGrid(){ 
        ...
        const data = this.props.getBlogsQuery;
        ...
        if(mat.length !== 0){
            ...
            let a = mat.map(asset => (
                ...
                <tr key = {asset.id}>
                    ...
                    <td className = 'hover one'><Link style={{textDecoration: 'none'}} to = {'/blog/title/' + asset.permalink}><div id={asset.id} style = {{width: '100%'}}>{asset.title}</div></Link></td>
        ...
        return(
            <div className='main__show home__box all__box' id='testScroll' onScroll = { this.handleScroll }>
                <div className='home__main'>
                    ...
                    <Link to='/blog/add' style={style}><div className = 'new__blog'>
...
export default compose(
    ...
    graphql(deleteBlogMutation, {name: 'deleteBlogMutation'})
