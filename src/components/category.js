...
import { deleteCategoryMutation } from '../queries/mutations';
        ...
        if(mat.length !== 0){
            ...
            let a = mat.map(asset => (
                ...
                <tr key = {asset.id}>
                    ...
                    <td className = 'hover one'><Link style={{textDecoration: 'none'}} to = {'/categories/title/' + asset.id}><div id={asset.id} style = {{width: '100%'}}>{asset.name}</div></Link></td>
        ...
        return(
            <div className='main__show home__box all__box' id='testScroll' onScroll = { this.handleScroll }>
                <div className='home__main'>
                    ...
                    <Link to='/categories/add' style={style}><div className = 'new__blog'>
