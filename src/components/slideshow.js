...
import { deleteSlideMutation } from '../queries/mutations';
...
class Slideshow extends React.Component {
    ...
    submitForm(e){ 
        ...
        var data = this.props.getSlidesQuery;
    ...
    displayGrid(){ 
        ...
        const data = this.props.getSlidesQuery;
        ...
        if(mat.length !== 0){
            ...
            let a = mat.map(asset => (
                ...
                <tr key = {asset.id}>
                    ...
                    <td className = 'hover one'><Link style={{textDecoration: 'none'}} to = {'/slideshow/title/' + asset.id}><div id={asset.id} style = {{width: '100%'}}>{asset.caption}</div></Link></td>
        ...
        return(
            <div className='main__show home__box all__box' id='testScroll' onScroll = { this.handleScroll }>
                <div className='home__main'>
                    ...
                    <Link to='/slideshow/add' style={style}><div className = 'new__blog'>
...
export default compose(
    ...
    graphql(deleteSlideMutation, {name: 'deleteSlideMutation'})
