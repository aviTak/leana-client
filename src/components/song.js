...
import { deleteSongMutation } from '../queries/mutations';
...
class Song extends React.Component {
    ...
    submitForm(e){ 
        ...
        var data = this.props.getSongsQuery;
    ...
    displayGrid(){ 
        ...
        const data = this.props.getSongsQuery;
        ...
        if(mat.length !== 0){
            ...
            let a = mat.map(asset => (
                ...
                <tr key = {asset.id}>
                    ...
                    <td className = 'hover one'><Link style={{textDecoration: 'none'}} to = {'/songs/title/' + asset.id}><div id={asset.id} style = {{width: '100%'}}>{asset.title}</div></Link></td>
        ...
        return(
            <div className='main__show home__box all__box' id='testScroll' onScroll = { this.handleScroll }>
                <div className='home__main'>
                    ...
                    <Link to='/songs/add' style={style}><div className = 'new__blog'>
