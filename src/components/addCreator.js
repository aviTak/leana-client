...
class AddCreator extends React.Component{
    ...
    addData(){
        ...
        const data = this.props.getCreatorQuery;
    ...
    submitForm(e){
        ...
        if(this.state.creatorId){ // Update post

            this.props.updateCreatorMutation({
    ...
    render(){
        return(
            <div className='main__show home__box all__box'>
                ...
                <Link to='/creators' style={style}><div className = 'back'><div className="set">&larr;</div></div></Link>
                ...
                <form id = "home-form" className="special" onSubmit = {this.submitForm} autoComplete="off">
                    ...
                    <div className = "home__field">
                        ...
                        <input id="readOnly" value={this.state.creatorId} type = "text" placeholder = "Automatically generated unique ID" onChange = { (e) => this.setState({creatorId: e.target.value}) } />
                    </div>
