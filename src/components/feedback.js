...
import { getFeedbacksQuery } from '../queries/queries';
import { deleteFeedbackMutation } from '../queries/mutations';
...
class Feedback extends React.Component {
    ...
    submitForm(e){ 
        ...
        var data = this.props.getFeedbacksQuery;
    ...
    displayGrid(){ 
        ...
        const data = this.props.getFeedbacksQuery;
        ...
        if(mat.length !== 0){
            ...
            let a = mat.map(asset => (
                ...
                <tr key = {asset.id}>
                    ...
                    <td className = 'hover one'><Link style={{textDecoration: 'none'}} to = {'/feedback/title/' + asset.id}><div id={asset.id} style = {{width: '100%'}}>{asset.name}</div></Link></td>
    ...
    deletePost(id){
        ...
        this.props.deleteFeedbackMutation({
    ...
    render(){
        ...
        return(
            <div className='main__show home__box all__box' id='testScroll' onScroll = { this.handleScroll }>
                <div className='home__main extra--bar'>
...
export default compose(
    ...
    graphql(getFeedbacksQuery, {
        name: 'getFeedbacksQuery',
        options: () => ({
            variables: {
                search: undefined, 
                first: undefined, 
    ...
    graphql(deleteFeedbackMutation, {name: 'deleteFeedbackMutation'})
