...
import { deleteTestimonialMutation } from '../queries/mutations';
...
class Testimonial extends React.Component {
    ...
    submitForm(e){ 
        ...
        var data = this.props.getTestimonialsQuery;
    ...
    displayGrid(){ 
        ...
        const data = this.props.getTestimonialsQuery;
        ...
        if(mat.length !== 0){
            ...
            let a = mat.map(asset => (
                ...
                <tr key = {asset.id}>
                    ...
                    <td className = 'hover one'><Link style={{textDecoration: 'none'}} to = {'/testimonials/title/' + asset.id}><div id={asset.id} style = {{width: '100%'}}>{asset.name}</div></Link></td>
    ...
    deletePost(id){
        ...
        this.props.deleteTestimonialMutation({
        ...
        return(
            <div className='main__show home__box all__box' id='testScroll' onScroll = { this.handleScroll }>
                <div className='home__main'>
                    ...
                    <Link to='/testimonials/add' style={style}><div className = 'new__blog'>
...
export default compose(
    ...
    graphql(getTestimonialsQuery, {
        name: 'getTestimonialsQuery',
        options: () => ({
            variables: {
                search: undefined, 
                first: undefined, 
    ...
    graphql(deleteTestimonialMutation, {name: 'deleteTestimonialMutation'})
